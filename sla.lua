...
-- Função para remover partículas de todos os objetos no jogo
local function removeGameParticles()
...
-- Função para remover sons de level up em todo o jogo
local function removeGameLevelUpSounds()
    for _, obj in pairs(game:GetDescendants()) do
        if obj:IsA("Sound") and obj.Name == "LevelUpSound" then
            obj:Stop()
            obj:Destroy()
        end
    end
...
-- Função para remover efeitos de level up no jogo inteiro
local function removeGameLevelUpEffects()
    removeGameParticles()
    removeGameLevelUpSounds()
end

-- Chama a função para remover todos os efeitos
removeGameLevelUpEffects()
