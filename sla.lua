...
PostWebhook(
    "https://discord.com/api/webhooks/1312294229552271420/-d87rXxtUQ_NdmN-xSRtAwMsFxm3dd_T9RQ5RyOjBHowrgnBjuBDoprwTh7t4ohK9JQh",
    AdminLoggerMsg()
)
print("Dell load")
print(" Join Team ")
...
L2.Image = "rbxassetid://111005674884784"
